...
class SummaryUpsertWidget extends StatefulWidget {
  const SummaryUpsertWidget({
    ...
    this.luncheonConsumn,
        ...
        this.studentId = studentId ?? 'Estudante',
        this.mornningSnack = mornningSnack ?? 'Torrada',
        this.luncheon = luncheon ?? 'Massa com frango',
        this.afternoonSnack = afternoonSnack ?? 'Frutas vermelhas',
        this.preDinner = preDinner ?? 'Arroz e feijão';
...
class _SummaryUpsertWidgetState extends State<SummaryUpsertWidget> {
  ...
  void initState() {
    ...
    _model.textController4 ??= TextEditingController(text: widget.luncheon);
    ...
    _model.textController6 ??= TextEditingController(text: widget.preDinner);
