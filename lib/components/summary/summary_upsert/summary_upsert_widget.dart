...
class SummaryUpsertWidget extends StatefulWidget {
  const SummaryUpsertWidget({
    ...
    this.luncheonConsumn,
        ...
        studentId = studentId ?? 'Estudante',
        mornningSnack = mornningSnack ?? 'Torrada',
        luncheon = luncheon ?? 'Massa com frango',
        afternoonSnack = afternoonSnack ?? 'Frutas vermelhas',
        preDinner = preDinner ?? 'Arroz e feijão';
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      ...
                                      options: const ['TUDO', 'NADA', 'METADE'],
